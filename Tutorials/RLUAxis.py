...
+'many features regarding the tick marks and setting limits are not working. A custom function has been generated to set the limits of the shown graph called '\
