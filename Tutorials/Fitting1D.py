...
title = 'Fitting of sequental 2D plots in as 1D Gaussians'

introText = 'After a spetrum has been measured, it is sensible to extract some of the physical quantities of excitations. In this tutorial, '\
...
+'the data is used. Secifically from 4.8 meV to 6.9 meV and the parameters wanted are the positions and widths of the magnon along two cuts in Q. '\
