...
.. |travis| image:: https://travis-ci.org/Jakob-Lass/MJOLNIR.svg?branch=1.1.8'
    :target: https://travis-ci.org/Jakob-Lass/MJOLNIR

.. |coverall| image:: https://coveralls.io/repos/github/Jakob-Lass/MJOLNIR/badge.svg?branch=1.1.8'
    :target: https://coveralls.io/github/Jakob-Lass/MJOLNIR?branch=1.1.8'
