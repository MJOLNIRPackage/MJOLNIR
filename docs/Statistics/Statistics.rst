...
This is the documentation part intended for the explanation of the statistics module. Due to the philosophy of this software suit where data visualization and actual data fitting and feature extraction are decoupled, this section is dedicated to explanation of the neede methods and workflows. 
The inteded methods could include:
...
- Advanced fitting routines for multidimensional data (2, 3, or n(?) dimensions) using:
    ...
    - Sequental fitting with blurring and rebinning of data to allow for initial fitting and guesses later used on the full data set
